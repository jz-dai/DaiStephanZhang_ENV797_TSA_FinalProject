...
4. *Socioeconomic factors data set including consumer price index (CPI), industrial production, merchandise exports, and merchandise imports.*
  ...
  - Format: csv file
  - Source \href{**INSERT LINK HERE**}{\textcolor{blue}{Federal Reserve Bank of Dallas}}
...
## add units
summary_df$Units <- c("ppb", "degrees Celsius", rep("index (2005=100)",4), "metric tons")
...
1.    **INSERT HERE WITH SAME FORMAT AS ABOVE**
